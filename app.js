...
// The value of "this" when joe.scope() is invoked would likely be the joe object.
//
// 2. What is "this" when joe.scopeArrow() is invoked?

//The value of "this" when joe.scopeArrow() is invoked would likely be the global scope (e.g., window object in a browser environment).
//
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not bind their own "this" value and instead inherit it from the surrounding code. 